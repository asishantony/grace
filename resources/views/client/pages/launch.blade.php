            ...
            function drawNumber(num) {
                ...
                for (var i = imageData.length; i >= 0; i -= 4) {
                    ...
                    if (imageData[i] !== 0) {
                        ...
                        var y = Math.floor(
                            Math.floor(i / numberStageWidth) / 4
                        );
...
*/
            function tweenDots(dot, pos, type) {
                ...
                if (type === "space") {
                    ...
                    TweenMax.to(
                        dot,
                        3 + Math.round(Math.random() * 100) / 100,
                        {
