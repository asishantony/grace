    ...
    <div class="users-list-table">
        <div class="card">
            <div class="card-content">
                <form  enctype="multipart/form-data" method="POST" action="/admin/facilities/{{$facility->id}}"
                    >
                   @method("PUT")
                    @csrf
                        <!-- form start -->
                    <div class="container">
                        <input type="hidden" name="program_id" value="{{$facility->id}}" />
                        <div class="input-field">
                            <input type="text" class="validate" id="name" name="name" value="{{$facility->name}}" />
                        ...
                        <div class="input-field">
                            ...
                            <input type="file" name="image" id="image" class="dropify"
                                data-default-file="{{asset('storage/'.$facility->image)}}" value="{{$facility->image}}" />
                        </div>
