...
function slideOutChat() {
    ...
    if (message != "") {
        var html =
            ...
            "</p>" +
            "</div></li>";
        $("#right-sidebar-nav #slide-out-chat .chat-body .collection").append(
            html
        );
        $(".search").val("");
        var charScroll = $(
...
$(function () {
                ...
                setTimeout(function () {
                    ...
                    if ($(".collapsible .open").children().length > 1) {
                        ...
                        var collapseInstance =
                            M.Collapsible.getInstance(collapseEl);
    ...
    if (!is_touch_device()) {
        ...
        if ($("#slide-out.leftside-navigation").length > 0) {
            if (
                ...
                var ps_leftside_nav = new PerfectScrollbar(
                    ".leftside-navigation",
                    {
                        wheelSpeed: 2,
        ...
        if ($(".slide-out-right-body").length > 0) {
            var ps_slideout_right = new PerfectScrollbar(
                ".slide-out-right-body #messages, .chat-body .collection",
                {
        ...
        if ($(".chat-body .collection").length > 0) {
            var ps_slideout_chat = new PerfectScrollbar(
                ".chat-body .collection",
                {
                    suppressScrollX: true,
                }
            );
    ...
    if (language !== null) {
        ...
        var selectedFlag = $(".dropdown-language .dropdown-item")
