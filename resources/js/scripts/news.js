$(document).ready(function () {
    ...
    if ($(".app-email .collection").length > 0) {
        var ps_email_collection = new PerfectScrollbar(
            ".app-email .collection",
            {
                theme: "dark",
                wheelPropagation: false,
            }
    ...
    $(
        ".email-compose-sidebar .cancel-email-item, .email-compose-sidebar .close-icon, .email-overlay"
    ).on("click", function () {
    ...
    if ($(".email-compose-sidebar").length > 0) {
        var ps_sidebar_compose = new PerfectScrollbar(
    ...
    $(" .email-compose-sidebar .send-email-item").on("click", function () {
        e.preventDefault();
